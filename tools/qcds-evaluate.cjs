...
const product = {
  "repo": "unity-build-package-prerelease-suite",
  "suitePath": "Packages/com.sunmax0731.unity.build.package.prerelease.suite/Samples~/representative-suite.json",
  "baselinePath": "docs/qcds-regression-baseline.json",
  "metricsPath": "docs/qcds-strict-metrics.json",
  "implFiles": [
    "Packages/com.sunmax0731.unity.build.package.prerelease.suite/package.json",
    "Packages/com.sunmax0731.unity.build.package.prerelease.suite/Editor/PrereleaseRuleEngine.cs",
    "Packages/com.sunmax0731.unity.build.package.prerelease.suite/Editor/UnityBuildPackagePrereleaseSuiteWindow.cs"
  ],
  "testFiles": [
    "tools/test-package-structure.ps1",
    "tools/test-representative-suite.cjs"
  ],
